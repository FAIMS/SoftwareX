...
While a detailed discussion of module code is out of scope for this paper, two documents discuss module creation from start to finish. `FAIMS User to Developer Documentation' (linked from: \url{https://www.fedarch.org/support/\#2}, archived: \url{https://perma.cc/8JDY-6RKL}) is designed to walk users through the creation of a module from first principles. The 'FAIMS Cookbook' is a tutorial covering data structures and API (linked from support page above, archived: \url{https://perma.cc/H6XJ-X6E2}).
